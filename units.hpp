...
namespace units
{
    class DimException : public std::exception 
    {
        ...
        public:
        DimException(char * msg) : message(msg) {}
        char * what () {
            return message;
        }
    };
    ...
    template<>
    struct is_mass<Kilogram<>>
    {
        static constexpr bool value = true;
    };

    template<>
    struct is_mass<SolarMass<>>
    {
        static constexpr bool value = true;
    };
    ...
    template<>
    struct is_length<Centimeter<>>
    {
        static constexpr bool value = true;
    };
    
    template<>
    struct is_length<Meter<>>
    {
        static constexpr bool value = true;
    };

    template<>
    struct is_length<Kilometer<>>
    {
        static constexpr bool value = true;
    };

    template<>
    struct is_length<Parsec<>>
    {
        static constexpr bool value = true;
    };
    ...
    template<>
    struct is_charge<Coulomb<>>
    {
        static constexpr bool value = true;
    };
    
    template<>
    struct is_charge<StatCoulomb<>>
    {
        static constexpr bool value = true;
    };
    ...
    template<>
    struct is_temp<Kelvin<>>
    {
        static constexpr bool value = true;
    };
    
    template<>
    struct is_temp<Celcius<>>
    {
        static constexpr bool value = true;
    };

    template<>
    struct is_temp<Fahrenheit<>>
    {
        static constexpr bool value = true;
    };

    template<>
    struct is_temp<ElectronVolt<>>
    {
        static constexpr bool value = true;
    };
    ...
    template<>
    struct is_angle<Radian<>>
    {
        static constexpr bool value = true;
    };
    
    template<>
    struct is_angle<Degree<>>
    {
        static constexpr bool value = true;
    };
    ...
    */
    ...
    struct quantity {
        ...
        Time_t T2         = Time_t::Second,             // Time unit type
        Charge_t Q2       = Charge_t::StatCoulomb,      // Charge unit type
        Temperature_t K2  = Temperature_t::Kelvin,      // Temperature unit type
        Irradiance_t I2   = Irradiance_t::ErgCM2P2,     // Luminous Intensity unit type
        Angle_t A2        = Angle_t::Radian>            // Angle unit type
        ...
        to(const quantity<P, m, l, t, q, temp, intensity, angle, M2, L2, T2, Q2, K2, I2, A2> uTransform) const
        {
            ...
            // if constexpr(std::is_integral_v<m>)
            {
                ...
                if (powq != 0)
                {
                    ...
                    } else if (uTransform.qType == Charge_t::StatCoulomb)  {
                ...
                if (powa != 0)
                {
                    ...
                    } else if (uTransform.aType == Angle_t::Radian)  {
    ...
    using charge        = quantity<double, std::ratio<0>, std::ratio<0>, std::ratio<0>, std::ratio<1>, std::ratio<0>, std::ratio<0>, std::ratio<0>>;
